...
val data  = spark.read.option("header","true").option("inferSchema", "true").format("csv").load("/home/guadalupe/Descargas/BigData-master/Spark_LogisticRegression/advertising.csv")
